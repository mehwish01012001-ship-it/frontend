...
const ProductDetails = () => {
  ...
  return (
    <>
      <Seo
        title={`${product.name} | Premium Stitched Collection`}
        description={product.description?.substring(0, 160) || "Explore our premium women's stitched outfits. Designed to perfection."}
        keywords={seoKeywords}
        canonicalUrl={canonicalUrl}
        ogType="product"
        ogTitle={`${product.name} | Premium Women's Wear`}
